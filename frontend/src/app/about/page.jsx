  ...
  return (
    <div className="bg-slate-50">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="mt-6 text-4xl md:text-6xl font-bold leading-tight">
              আপনার বিশ্বস্ত
              <span className="block text-yellow-300">অনলাইন শপিং সঙ্গী</span>
            </h1>
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/products"
                className="bg-white text-indigo-600 px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                এখনই শপ করুন
              </Link>
              ...
              <a
                href="#mission"
                className="border border-white/30 px-8 py-4 rounded-xl font-semibold backdrop-blur hover:bg-white/10 transition"
              >
                আরও জানুন
              </a>
            </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-slate-50 border">
      ...
      <section className="px-6 pb-20">
        <div className="max-w-6xl mx-auto rounded-[32px] bg-gradient-to-r from-indigo-600 to-purple-600 p-10 md:p-16 text-center text-white">
          ...
          <Link
            href="/products"
            className="inline-block mt-8 bg-white text-indigo-600 px-8 py-4 rounded-xl font-semibold hover:scale-105 transition"
          >
            এখনই শপ করুন
          </Link>
        </div>
